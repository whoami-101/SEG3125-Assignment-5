...
const universityData = [
  { name: 'McMaster University', ftUndergrad: 30000, ftGrad: 4800, ptUndergrad: 1200 },
  { name: 'University of Ottawa', ftUndergrad: 36300, ftGrad: 7000, ptUndergrad: 5000 },
  { name: 'Brock University', ftUndergrad: 15600, ftGrad: 1600, ptUndergrad: 1700 },
...
const translations = {
  en: {
    ...
    dashboardSubtitle: 'Fall 2024 Enrolment Data | Data from the site Universities Canada | Source: Association of Atlantic Universities, Council of Ontario Universities, Individual institutions, Bureau de coopération interuniversitaire',
    barChartTitle: 'Full-Time Undergraduate Enrolment',
    doughnutChartTitle: 'Enrolment Breakdown for',
    ftUndergrad: 'Full Time Undergrad',
    ftGrad: 'Full Time Grad',
    ptUndergrad: 'Part Time Undergrad',
  ...
  fr: {
    ...
    dashboardSubtitle: 'Données d\'inscription pour l\'automne 2024 | Données du site Universités Canada | Source : Association des universités de l\'Atlantique, Conseil des universités de l\'Ontario, Établissements individuels, Bureau de coopération interuniversitaire',
...
const EnrolmentDoughnutChart = ({ university, t }) => {
    ...
    return (
        <Card>
            {/* FIX: Removed the 'truncate' class to allow the title to wrap */}
            <h2 className="chart-title">{t.doughnutChartTitle} {university.name}</h2>
             <div style={{ width: '100%', height: 300 }}>
                <ResponsiveContainer>
                    <PieChart>
                        <Pie
